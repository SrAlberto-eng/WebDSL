package com.web.traductor;

import java.io.FileWriter;
import java.nio.file.Path;

import com.web.traductor.astnodes.NodoPagina;
import com.web.traductor.lexer.LexicalException;
import com.web.traductor.lexer.WebLexer;
import com.web.traductor.parser.SyntaxException;
import com.web.traductor.parser.WebParser;
import com.web.traductor.simbols.Simbolo;
import com.web.traductor.simbols.TablaSimbolos;
import com.web.traductor.traductor.GenerationException;
...
public class PruebaParser {
    private static final String INPUT  = "src/main/java/com/web/traductor/input.markup";
